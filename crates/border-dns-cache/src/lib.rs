...
use border_dns_protocol::name::DomainName;
...
mod tests {
    ...
    use border_dns_protocol::question::DnsQuestion;
    use border_dns_protocol::rr::RData;
    use border_dns_protocol::rr::ResourceRecord;
